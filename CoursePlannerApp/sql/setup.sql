...
--Creating tables
--Term
create table terms (term_id number GENERATED by default as IDENTITY (START WITH 7) PRIMARY KEY, 
                    term_name char(6) NOT NULL);

--Domain
create table domains (domain_id number GENERATED by default as IDENTITY (START WITH 4) PRIMARY KEY, 
...
CREATE TABLE courseapp_groups (
    id  NUMBER GENERATED BY DEFAULT AS IDENTITY (START WITH 3) PRIMARY KEY,
